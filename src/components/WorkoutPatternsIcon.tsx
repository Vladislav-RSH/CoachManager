function WorkoutPatternsIcon() {

    return (

        <svg className="w-5 h-5" fill="#fff" height="200px" width="200px" version="1.1" id="Layer_1" 
                ...
                <g> 
                    <g> 
                        <g> 
                            ...
                            c5.867,0,10.667-4.8,10.667-10.667v-224C245.333,271.467,240.533,266.667,234.667,266.667z 
                            M224,490.667H21.333V288H224V490.667z "></path> 
                            <path d="M501.333,266.667H288c-5.867,0-10.667,4.8-10.667,10.667v224c0,5.867,4.8,10.667,10.667,10.667h213.333 
                            C507.2,512,512,507.2,512,501.333v-224C512,271.467,507.2,266.667,501.333,266.667z 
                            M490.667,490.667h-192V288h192V490.667z"></path> 
                        </g> 
                    </g> 
                </g> 
            </g>
...
export default WorkoutPatternsIcon;